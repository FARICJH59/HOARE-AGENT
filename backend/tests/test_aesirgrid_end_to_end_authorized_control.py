...
This test connects the existing product factory, synthetic shadow analysis,
authority lease, product authorization, and executor-neutral seam. It uses a
recording fake executor so no physical or provider operation occurs.
"""
